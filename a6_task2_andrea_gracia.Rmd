...
## Summary
Our findings show that there is a significant association between political association and 'environmentalist' self-identification ($\chi$^2^(`r survey_tidy$parameter`) = `r round(survey_tidy$statistic,2)`, *p* = `r round(survey_tidy$p.value, 3)`). Half of those who identified themselves as conservatives, also did not identify themselves as an environmentalist. The opposite trend is seen in the Liberal category in which 54% considered themselves an environmentalist. Overall, self-identified conservatives seem to be more certain of whether they are a conservative or not (16%) compared to liberals (21%) because of their lower percentage in the unsure category. 
