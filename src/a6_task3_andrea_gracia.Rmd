...
Compare total lengths (variable = total_length, in millimeters) for female lizards (sex == “F”) of two species (variable spp): CNUN (Cnemidophorus uniparens, the Desert Grassland lizard) and CNTE (Cnemidophorus tessalatus, the Colorado Checkered lizard).
...
**Figure 1** compares.....The means and standard errors of the populations are plotted, which makes it easier to visually discern how .... data spread compares to the average.
...
## Findings 
A 1 - 2 sentence summary statement describing your findings, that at least includes: the results of your hypothesis test, the effect size, and the actual means difference between the two groups
