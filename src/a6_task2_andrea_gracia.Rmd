...
## Summary
There is a significant association between political association and 'environmentalist' self-identification ($\chi$^2^(`r survey_tidy$parameter`) = `r round(survey_tidy$statistic,2)`, *p* = `r round(survey_tidy$p.value, 3)`). 
